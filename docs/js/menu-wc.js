...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@experiments72/basic-service documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/BasicController.html" data-type="entity-link" >BasicController</a>
                            </li>
                            <li class="link">
                                <a href="classes/BasicService.html" data-type="entity-link" >BasicService</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ControllerHandler.html" data-type="entity-link" >ControllerHandler</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/RouterControllerMap.html" data-type="entity-link" >RouterControllerMap</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ServerApplication.html" data-type="entity-link" >ServerApplication</a>
                            </li>
                            <li class="link">
